    ...
    if (this.state.IsExchangeRequestActive === true){
      ...
      return(
        <View style = {{flex:1,justifyContent:'center'}}>
         <View style={{borderColor:'#008080',borderWidth:2,justifyContent:'center',alignItems:'center',padding:10,margin:10}}>
         <Text>Item Name</Text>
         ...
         <TouchableOpacity style={{borderWidth:1,borderColor:'#008080',backgroundColor:'#008080',width:300,alignSelf:'center',alignItems:'center',height:30,marginTop:30}}
         onPress={()=>{
